...
var getHeader = function (font, props) {
	...
	if (state.getName() == "home") {
		return (
			...
			<div key={state.getName()} className="relative width height-600 raised cutoff">
				...
				<div className="absolute width20 height-100 bottom-0 right0">
					<ButtonGroup isActive={props.button.isActive} change={props.button.change} styles={props.button.styles}/>
				</div>
			</div>
		...
		return (
			...
			<div key={state.getName()} className="relative width height-600 raised cutoff">
				...
				<div className="absolute width height" id="splash">
					<img className="absolute width height-auto" src={"/" + props.img + ".jpg"} id="banner" />
				</div>
